...
export default function Widgets() {
  return (
    <div className="px-4 sm:px-6 space-y-6 sm:space-y-8 mt-20 lg:mt-0">
      
      {/* Page title */}
      <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Widgets</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mt-2 sm:mt-6">

        {/* Mini Chart placeholder */}
        <div className="bg-white shadow-md rounded-xl p-6 h-56 sm:h-64 flex items-center justify-center">
          <p className="text-gray-500 text-sm sm:text-base">📊 Chart Coming Soon...</p>
        </div>
...
const StatBox = ({ icon, title, value }) => {
  return (
    <div className="bg-white shadow-md rounded-xl p-4 sm:p-6 flex items-center gap-4 hover:shadow-lg transition cursor-pointer">
